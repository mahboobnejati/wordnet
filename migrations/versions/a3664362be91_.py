...
Revision ID: a3664362be91
Revises: 
Create Date: 2017-05-17 14:50:17.250130
...
def upgrade():
    ...
    sa.Column('language', sa.Enum('farsi', 'english', 'arabic', 'other language'), nullable=True),
    sa.Column('moreInfo', sa.String(length=1000), nullable=True),
    ...
    sa.Column('language', sa.Enum('farsi', 'english', 'arabic', 'other language'), nullable=True),
    sa.Column('source', sa.Enum('response', 'insta tag', 'karbaran'), nullable=True),
    ...
    sa.Column('gender', sa.Enum('female', 'male'), nullable=True),
    sa.Column('degree', sa.Enum('phd', 'master', 'upper graduate', 'graduate', 'under graduate'), nullable=True),
    sa.Column('nativeLanguage', sa.Enum('farsi', 'other language'), nullable=True),
    ...
    sa.ForeignKeyConstraint(['questionnaire_id'], [u'questionnaire.id'], ),
    ...
    sa.ForeignKeyConstraint(['picture_id'], [u'picture.id'], ),
    sa.PrimaryKeyConstraint('id'),
    ...
    sa.ForeignKeyConstraint(['graph_id'], [u'graph.id'], ),
    sa.ForeignKeyConstraint(['phrase1_id'], [u'phrase.id'], ),
    sa.ForeignKeyConstraint(['phrase2_id'], [u'phrase.id'], ),
    ...
    sa.Column('graph_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['graph_id'], [u'graph.id'], ),
    sa.ForeignKeyConstraint(['phrase_id'], [u'phrase.id'], ),
    ...
    sa.Column('phrase_id', sa.Integer(), nullable=False),
    sa.Column('weight', sa.Float(), nullable=True),
    sa.ForeignKeyConstraint(['dictionary_id'], [u'dictionary.id'], ),
    sa.ForeignKeyConstraint(['phrase_id'], [u'phrase.id'], ),
    ...
    sa.ForeignKeyConstraint(['pack_id'], [u'pack.id'], ),
    sa.ForeignKeyConstraint(['phrase1_id'], [u'phrase.id'], ),
    sa.ForeignKeyConstraint(['phrase2_id'], [u'phrase.id'], ),
    ...
    sa.ForeignKeyConstraint(['id'], [u'phrase.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
